          ...
          <main className="grid min-w-0 gap-6">
            ...
            <section id="resume" className="min-w-0 max-w-full overflow-hidden scroll-mt-24 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm md:p-8">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <a
                  className={`inline-flex items-center justify-center gap-2 rounded-full bg-slate-950 px-4 py-2 text-sm font-black text-white transition hover:bg-teal-700 ${focusRing}`}
                  download
                  href={profileSummary.resumeUrl}
                >
                  Download resume
